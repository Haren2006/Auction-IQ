...
# =========================
# Sample rows for Example mode
# Aligned to project snapshots/checkpoints
# =========================
EXAMPLE_ROWS = [
    {
...
# Replace these functions with your saved model artifacts later.
# For now, this keeps the UI fully runnable for teammates.
# =========================
